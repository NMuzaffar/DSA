...
/**
 * <a href="https://structy.net/problems/island-count">Island Count</a>
 */
public class IslandCount {

  public static void main(String[] args) {
    assertEquals(3, islandCount(List.of(
        List.of("W", "L", "W", "W", "W"),
        List.of("W", "L", "W", "W", "W"),
        List.of("W", "W", "W", "L", "W"),
        List.of("W", "W", "L", "L", "W"),
    ...
    assertEquals(4, islandCount(List.of(
        List.of("L", "W", "W", "L", "W"),
        List.of("L", "W", "W", "L", "L"),
        List.of("W", "L", "W", "L", "W"),
        List.of("W", "W", "W", "W", "W"),
    ...
    assertEquals(1, islandCount(List.of(
        List.of("L", "L", "L"),
        List.of("L", "L", "L"),
        List.of("L", "L", "L")
    )));

    assertEquals(0, islandCount(List.of(
        List.of("W", "W"),
        List.of("W", "W"),
        List.of("W", "W")
    )));
  ...
  private static void dfs(int row, int col, List<List<String>> grid, boolean[][] visited) {
